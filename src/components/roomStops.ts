...
export const STOPS: Stop[] = [
  ...
  { id: "involvement", wall: "right", pos: [-3.0, 2.2, 11.5], look: [ 10.6, 0.1, -2.8], close: [ 5.0, 0.3, -2.8] },
  { id: "contact",     wall: "right", pos: [-3.0, 2.2, 10.8], look: [ 10.6, 0.1,  1.5], close: [ 5.0, 0.3,  1.5] },
];
